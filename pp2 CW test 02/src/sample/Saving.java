...
public class Saving {
    ...
    public static void saved(){
        ...
        TextField c_tf2 = new TextField();//For Interest amount label.
        c_tf2.setLayoutY(127.0);
        c_tf2.setLayoutX(115.0);
        c_tf2.setMinSize(149,25);
        c_tf2.setId("c_tf");

        TextField c_tf3 = new TextField();//For Duration label.
        c_tf3.setLayoutY(167.0);
        c_tf3.setLayoutX(115.0);
        c_tf3.setMinSize(149,25);
        c_tf3.setId("c_tf");

        TextField c_tf4 = new TextField();// For final amount label.
        c_tf4.setLayoutY(207.0);
        c_tf4.setLayoutX(115.0);
        c_tf4.setMinSize(149,25);
        c_tf4.setId("c_tf");

        TextField c_tf5 = new TextField();// Regular payment label.
        ...
        c_ap4.setId("c_ap");
        // Toolbar to help user navigation.(Compound,Mortgage & loan)
        ToolBar toolBar = new ToolBar();
        toolBar.setLayoutY(15.0);
        toolBar.setLayoutX(600.0);
        ...
        c_btn1.setOnAction(actionEvent ->{
            ...
            if(!c_tf2.getText().equals("") && !c_tf1.getText().equals("") && !c_tf3.getText().equals("") && !c_tf5.getText().equals("")){
                ...
                Step_1 = (Math.pow((1 + ((Interest/100)/n)),(n*Duration)))-1;
                Step_2 = ((Interest/100)/n);
                Step_3 = Reg_p *(Step_1/Step_2);
                Step_4 =  Initial_a*(Math.pow((1+((Interest/100)/n)),(n*Duration)));
                Final_a = new Double(df.format((Step_4+Step_3))).doubleValue();
                F_amount=Double.toString(new Double(Final_a));
                I_charged=Double.toString(new Double(df.format((Final_a-Initial_a))).doubleValue());
                Number_payments = Double.toString(new Double(df.format((Duration*12))).doubleValue());
                Flag = "final_amount";
                ...
                Step_2 = ((Interest/100)/n);
                Step_3 = Reg_p *(Step_1/Step_2);
                Step_4 = (Final_a-Step_3)/(Math.pow((1+((Interest/100)/n)),(n*Duration)));
                Initial_a = new Double(df.format((Step_4))).doubleValue();
                ...
                Step_1 = Final_a - (Initial_a*(Math.pow((1+(Interest/100)/12),(n*Duration))));
                Step_2 = Math.pow((1+(Interest/100)/n),(n*Duration))-1;
                Step_3 = (Interest/100)/n;
                Step_4 = Step_2/Step_3;
                Step_5 = Step_1/Step_4;
                Reg_p = new Double(df.format((Step_5))).doubleValue();
                ...
                Double Interest = Double.parseDouble(Int)/100;
                Double  Initial_a = Double.parseDouble(I_amount);
                Double Reg_p = Double.parseDouble(R_payment);
                Double n = Double.parseDouble(Num);
                Double  Final_a= Double.parseDouble(F_amount);
                ...
                Step_1 = Math.log(((((Interest*Final_a)/n)+Reg_p)/(((Initial_a*Interest)/n)+Reg_p)));
                Step_2 =(n*Math.log(1+(Interest/n)));
            ...
            if (Flag == "final_amount"){
                ...
                c_lb15.setText(Number_payments );
                c_lb16.setText(Dur);
            ...
            if(Fail == "0") {
                ...
                ObservableList<PieChart.Data> pieChartData =
                        FXCollections.observableArrayList(
                                ...
                                new PieChart.Data("Interest Earned", I_charged1));
        ...
        // opens compounding view and closes Savings view.
        Compound_b.setOnAction(actionEvent ->{
            CompoundInterest.Compounding();
            stage1.close();
        });
        // opens Loan view and closes Savings view.
        loan_b.setOnAction(actionEvent ->{
            Loan.Loaning();
            stage1.close();
        });
        // opens Mortgage and closes Savings view.
