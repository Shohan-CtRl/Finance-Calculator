...
public class Mortgage {
    ...
    public static void Mortgaging(){


        //Creating Labels
        Label c_lb1 = new label();
        c_lb1.setText("Mortgage\n"+"CALCULATOR");
        ...
        // Toolbar to help user navigation.(Savings,Compound & loan)
        ...
        c_btn1.setOnAction(actionEvent ->{
            ...
            if(!c_tf2.getText().equals("") && !c_tf1.getText().equals("") && !c_tf3.getText().equals("") && !c_tf5.getText().equals("")){
                ...
                Double Duration = (Double.parseDouble(Dur))*12;
                ...
                Final_a = new Double(df.format((Step_3))).doubleValue();
                ...
                Duration = new Double(df.format((Step_3/12))).doubleValue();
        ...
        // opens compounding view and closes mortgage view.
        Compound_b.setOnAction(actionEvent ->{
            CompoundInterest.Compounding();
            stage1.close();
        });
        // opens Saving view and closes mortgage view.
        Saving_b.setOnAction(actionEvent ->{
            Saving.saved();
            stage1.close();
        });
        // opens Loan view and closes mortgage view.
